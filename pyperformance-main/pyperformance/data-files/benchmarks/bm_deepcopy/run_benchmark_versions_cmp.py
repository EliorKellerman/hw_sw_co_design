...
if __name__ == "__main__":
    ...
    # final optimisied verison deepcopy
    runner.bench_time_func('deepcopy_opt', lambda n: benchmark(n, copy_opt.deepcopy))
    runner.bench_time_func('deepcopy_opt_reduce', lambda n: benchmark_reduce(n, copy_opt.deepcopy))
    runner.bench_time_func('deepcopy_opt_memo', lambda n: benchmark_memo(n, copy_opt.deepcopy))
